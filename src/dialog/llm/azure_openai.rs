...
impl Default for AzureOpenAiConfigDialog {
    fn default() -> Self {
        Self::new()
    }
}
...
impl AzureOpenAiConfigDialog {
    pub fn new() -> Self {
        Self {
            config: AzureOpenAiConfig::default(),
            error_active: false,
    ...
    pub fn new_with_config(config: Config, azure_config: AzureOpenAiConfig) -> Self {
        Self {
            config: azure_config,
            error_active: false,
            show_instructions: true,
                    ...
                    return Some(Action::LlmClientDialogApplied(
                        {
                            ...
                            lc.azure = Some(self.config.clone());
                            lc
                        }
                    ));
                }
